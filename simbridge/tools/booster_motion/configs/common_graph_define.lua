...
local graph = {
    ...
    modules = {
        ...
        parallel_mech_input_rl_locomotion_run = "parallel_mech::BipedParallelFeetInput",
        parallel_mech_input_rl_locomotion_gait_2 = "parallel_mech::BipedParallelFeetInput",
        parallel_mech_input_rl_fall_recovery = "parallel_mech::BipedParallelFeetInput",
    ...
    connections = {
        ...
        -------------------------- connect to parallel_mech_input_rl_locomotion_run -----------------
        con_commander_manager_2_pmi_rl_locomotion_run = {
            output_module = "command_manager",
            output_message_name = "is_parallel_input_",
            input_module = "parallel_mech_input_rl_locomotion_run",
            input_message_name = "is_parallel_input",
        },
        con5_rl_locomotion_run = {
            output_module = "rl_locomotion_run",
            output_message_name = "motor_command",
            input_module = "parallel_mech_input_rl_locomotion_run",
            input_message_name = "motor_pvt_commands_serial",
        },
        con_pi_1_rl_locomotion_run = {
            output_module = "joint_map_output",
            output_message_name = "joint_states_mapped",
            input_module = "parallel_mech_input_rl_locomotion_run",
            input_message_name = "joint_states_parallel",
        },
        con_pi_2_rl_locomotion_run = {
            output_module = "parallel_mech_output",
            output_message_name = "joint_states_serial",
            input_module = "parallel_mech_input_rl_locomotion_run",
            input_message_name = "joint_states_serial",
        ...
        -------------------------- connect to parallel_mech_input_rl_locomotion_gait_2 -----------------
        con_commander_manager_2_pmi_rl_locomotion_gait_2 = {
            output_module = "command_manager",
            output_message_name = "is_parallel_input_",
            input_module = "parallel_mech_input_rl_locomotion_gait_2",
            input_message_name = "is_parallel_input",
        },
        con5_rl_locomotion_gait_2 = {
            output_module = "rl_locomotion_gait_2",
            output_message_name = "motor_command",
            input_module = "parallel_mech_input_rl_locomotion_gait_2",
            input_message_name = "motor_pvt_commands_serial",
        },
        con_pi_1_rl_locomotion_gait_2 = {
            output_module = "joint_map_output",
            output_message_name = "joint_states_mapped",
            input_module = "parallel_mech_input_rl_locomotion_gait_2",
            input_message_name = "joint_states_parallel",
        },
        con_pi_2_rl_locomotion_gait_2 = {
            output_module = "parallel_mech_output",
            output_message_name = "joint_states_serial",
            input_module = "parallel_mech_input_rl_locomotion_gait_2",
            input_message_name = "joint_states_serial",
        ...
        -------------------------- connect to parallel_mech_input_rl_fall_recovery -----------------
        con_commander_manager_2_pmi_rl_fall_recovery = {
            output_module = "command_manager",
            output_message_name = "is_parallel_input_",
            input_module = "parallel_mech_input_rl_fall_recovery",
            input_message_name = "is_parallel_input",
        },
        con5_rl_fall_recovery = {
            output_module = "rl_fall_recovery",
            output_message_name = "motor_command",
            input_module = "parallel_mech_input_rl_fall_recovery",
            input_message_name = "motor_pvt_commands_serial",
        },
        con_pi_1_rl_fall_recovery = {
            output_module = "joint_map_output",
            output_message_name = "joint_states_mapped",
            input_module = "parallel_mech_input_rl_fall_recovery",
            input_message_name = "joint_states_parallel",
        ...
        con_rl_locomotion_run = {
            output_module = "parallel_mech_input_rl_locomotion_run",
            output_message_name = "motor_pvt_commands_parallel",
            input_module = "planner_pvt_switch",
            input_message_name = "in_8",
        },
        con_rl_fall_recovery = {
            output_module = "parallel_mech_input_rl_fall_recovery",
            output_message_name = "motor_pvt_commands_parallel",
            input_module = "planner_pvt_switch",
            input_message_name = "in_9",
        },
        con_rl_locomotion_gait_2 = {
            output_module = "parallel_mech_input_rl_locomotion_gait_2",
            output_message_name = "motor_pvt_commands_parallel",
            input_module = "planner_pvt_switch",
        ...
        con_hand_direct_command_planner_14 = {
            output_module = "command_manager",
            output_message_name = "file_traj_index_",
            input_module = "hand_direct_command_planner",
            input_message_name = "file_traj_index_",
        },
        ...
        con_joint_force_intercept_motor_cmd = {
            output_module = "simulator_out",
            output_message_name = "joint_forces",
            input_module = "intercept_motor_cmd",
        ...
        -------------------------- connect to rl_fall_recovery --------------------------
        con_rl_fall_recovery_1 = {
            output_module = "parallel_mech_output",
            output_message_name = "joint_states_serial",
            input_module = "rl_fall_recovery",
            input_message_name = "motor_state_feedback",
        },
        con_rl_fall_recovery_2 = {
            output_module = "simulator_out",
            output_message_name = "imu_sensor_data",
            input_module = "rl_fall_recovery",
            input_message_name = "imu_feedback",
        },
        con_rl_fall_recovery_3 = {
            output_module = "parallel_mech_output",
            output_message_name = "jacobian_inv",
            input_module = "rl_fall_recovery",
            input_message_name = "jacobian_inv",
        ...
        -------------------------- connect to rl_locomotion_fallen_portal_collect --------------------------
        con_portal_collect_module_b = {
            output_module = "rl_locomotion",
            output_message_name = "robot_fallen",
            input_module = "rl_locomotion_fallen_portal_collect",
            input_message_name = "input",
        },

        -------------------------- connect to rl_locomotion_run_fallen_portal_collect --------------------------
        con_portal_collect_module_c = {
            output_module = "rl_locomotion_run",
            output_message_name = "robot_fallen",
            input_module = "rl_locomotion_run_fallen_portal_collect",
            input_message_name = "input",
        },

        -------------------------- connect to rl_locomotion_gait_2_fallen_portal_collect --------------------------
        con_portal_collect_module_d = {
            output_module = "rl_locomotion_gait_2",
            output_message_name = "robot_fallen",
            input_module = "rl_locomotion_gait_2_fallen_portal_collect",
            input_message_name = "input",
        },
        ...
        -------------------------- connect to custom_traj_finished_portal_collect --------------------------
        con_portal_collect_custom_traj_finished = {
            output_module = "custom_traj",
            output_message_name = "traj_finished",
            input_module = "custom_traj_finished_portal_collect",
            input_message_name = "input",
        },

        -------------------------- connect to custom_traj_finished_portal_publish --------------------------
        -- None

        ------------------------- connect to fall_down_recovery ---------------------------------
        con_fall_down_recovery_1 = {
            output_module = "simulator_out",
            output_message_name = "imu_sensor_data",
            input_module = "fall_down_recovery",
            input_message_name = "imu_data",
        },
        con_fall_down_recovery_2 = {
            output_module = "parallel_mech_output",
            output_message_name = "joint_states_serial",
            input_module = "fall_down_recovery",
            input_message_name = "joint_state",
        },
        con_fall_down_recovery_3 = {
            output_module = "parallel_mech_output",
            output_message_name = "joint_forces_serial",
            input_module = "fall_down_recovery",
            input_message_name = "joint_forces",
        },
        con_fall_down_recovery_4 = {
            output_module = "command_manager",
            output_message_name = "is_doing_stand_up",
            input_module = "fall_down_recovery",
            input_message_name = "is_doing_stand_up",
        },

        -------------------------- connect to stand_up_type_idx_portal_collect --------------------------
        con_portal_collect_stand_up_type_idx = {
            output_module = "fall_down_recovery",
            output_message_name = "custom_traj_idx",
            input_module = "stand_up_type_idx_portal_collect",
            input_message_name = "input",
        },

        -------------------------- connect to stand_up_type_idx_portal_publish --------------------------
        -- None

        -------------------------- connect to fdr_state_portal_collect --------------------------
        con_portal_collect_fdr_state = {
            output_module = "fall_down_recovery",
            output_message_name = "fall_down_recovery_state",
            input_module = "fdr_state_portal_collect",
            input_message_name = "input",
        },

        -------------------------- connect to fdr_state_portal_publish --------------------------
        -- None

        -------------------------- connect to is_recovery_avalible_portal_collect --------------------------
        con_portal_collect_is_recovery_avalible = {
            output_module = "fall_down_recovery",
            output_message_name = "is_recovery_avalible",
            input_module = "is_recovery_avalible_portal_collect",
            input_message_name = "input",
        },

        -------------------------- connect to is_recovery_avalible_portal_publish --------------------------
        -- None
    },
}
...
function graph.init(arg1)
    ...
    if is_real_bot then
        ...
        -------------------------- connect to parallel_mech_input_rl_locomotion_run ----------------
        graph.connections.con_pi_1_rl_locomotion_run = {
            output_module = "simulator_out",
            output_message_name = "joint_states",
            input_module = "parallel_mech_input_rl_locomotion_run",
            input_message_name = "joint_states_parallel",
        ...
        -------------------------- connect to parallel_mech_input_rl_locomotion_gait_2 ----------------
        graph.connections.con_pi_1_rl_locomotion_gait_2 = {
            output_module = "simulator_out",
            output_message_name = "joint_states",
            input_module = "parallel_mech_input_rl_locomotion_gait_2",
            input_message_name = "joint_states_parallel",
        ...
        -------------------------- connect to parallel_mech_input_rl_fall_recovery ----------------
        graph.connections.con_pi_1_rl_fall_recovery = {
            output_module = "simulator_out",
            output_message_name = "joint_states",
            input_module = "parallel_mech_input_rl_fall_recovery",
            input_message_name = "joint_states_parallel",
